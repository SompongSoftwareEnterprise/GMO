...
class StaffRequestsController extends BaseController {
	...
	public function view($form,$id) {
		if($form == '11') {
			...
			$form = CertificateRequestForm::where('export_certificate_request_id', '=', $request->id)->first();
			$example = CertificateRequestExample::where('export_certificate_request_form_id', '=', $form->id)->get();
